...
pub const TECHS: &[Tech] = &[
    ...
    Tech {
        ...
        name: "机动外骨骼",
        icon: "battery_cell",
        cost: &[("data", 22), ("circuit", 6), ("battery_cell", 2)],
        time: 32.0,
        pos: (1080.0, 660.0),
        req: &["exosuit"],
        desc: "解锁 Q 冲刺推进，短距离高速位移。",
        unlocked: false,
    },
    Tech {
        id: "exo_optics",
        name: "战术目镜",
        icon: "gold",
        cost: &[("data", 24), ("gold", 4), ("glass_b", 6)],
        time: 34.0,
        pos: (900.0, 730.0),
        req: &["exosuit"],
        desc: "解锁 B 夜视与 F 头灯，黑暗环境行动自如。",
        unlocked: false,
    },
    Tech {
        id: "exo_shielding",
        name: "护盾爆发器",
        icon: "superconductor",
        cost: &[("data", 30), ("superconductor", 3), ("battery_cell", 4)],
        time: 40.0,
        pos: (1240.0, 640.0),
        req: &["exo_mobility", "combat"],
        desc: "解锁 X 护盾冲击波：消耗护盾击退并伤害周围生物。",
        unlocked: false,
    },
    Tech {
        id: "exo_recycler",
        name: "应急氧气回收",
        icon: "oxygen_cell",
        cost: &[("data", 26), ("biofiber", 4), ("filter_core", 2)],
        time: 36.0,
        pos: (1080.0, 780.0),
        req: &["exosuit", "biotech"],
        desc: "解锁 Z 应急供氧：将护盾能量转化为氧气。",
        unlocked: false,
    },
    Tech {
        id: "ship_systems",
