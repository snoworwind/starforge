...
pub fn item_icon(atlas: &Atlas, item_key: &str) -> IconBuf {
    ...
    match def.icon_fn {
        ...
        Some("basalt_shard") => chunk_icon("#3a3a42"),
        Some("cryocrystal") => crystal_icon("#69dce8", "#d8fbff"),
        Some("sulfur") => crystal_icon("#d8c63a", "#fff38a"),
        Some("resin") => crystal_icon("#d69232", "#ffd478"),
        Some("ferrite") => chunk_icon("#9a5a38"),
        Some("spores") => crystal_icon("#9a5fd0", "#e0b8ff"),
        Some("enzyme") => crystal_icon("#2e8a72", "#7dffcf"),
        Some("chitin") => chunk_icon("#d8862a"),
        Some("obsidian_shard") => crystal_icon("#24242d", "#7a6aa8"),
        Some("salt_crystal") => crystal_icon("#dce8ee", "#ffffff"),
        Some("silica") | Some("silicon_wafer") => crystal_icon("#96a8b8", "#e2f2ff"),
        Some("nickel") => chunk_icon("#91a58f"),
        Some("cobalt") => chunk_icon("#356ec8"),
        Some("polymer") | Some("biofiber") => plate_icon(),
        Some("acid") => crystal_icon("#b8d932", "#ecff82"),
        Some("coolant") => crystal_icon("#35bfe0", "#b8f4ff"),
        Some("heat_alloy") | Some("ship_alloy") => ingot_icon("#596673", "#d8e2ea"),
        Some("superconductor") => wire_icon(),
        Some("battery_cell") | Some("hazard_cell") => crystal_icon("#e8a938", "#fff0a0"),
        Some("filter_core") | Some("advanced_circuit") => circuit_icon(),
        Some("fluid_canister") | Some("oxygen_cell") => oxygen_icon(),
